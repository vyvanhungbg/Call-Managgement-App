...
public class CustomBackupAgent extends BackupAgent {
    ...
    public void onBackup(ParcelFileDescriptor parcelFileDescriptor, BackupDataOutput backupDataOutput, ParcelFileDescriptor parcelFileDescriptor1) throws IOException {
        ...
        Log.e("Call Management","Chuẩn bị tiến hành sao lưu");
    }
    ...
    public void onQuotaExceeded(long backupDataBytes, long quotaBytes) {
        ...
        Log.e("Call Management","Đã đạt tới giới hạn sao lưu");
    }
    ...
    public void onDestroy() {
        ...
        Log.e("Call Management","Sao lưu hoàn tất");
    }

    @Override
    public void onRestoreFinished() {
        super.onRestoreFinished();
        Log.e("Call Management","Hoàn thành sao lưu dữ liệu cũ");
